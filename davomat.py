...
async def _chegirma_hisobla(yozilish_id: str, guruh_page: dict, sana: str):
    ...
    if joriy >= limit:
        # Bu talaba uchun limit allaqachon tugagan. Agar boshqa barcha
        # talabalar ham tugagan bo'lsa, umumiy yozuvni "Tugagan" deb belgilaymiz
        # — aks holda status noto'g'ri "Faol" bo'lib qolib ketaveradi.
